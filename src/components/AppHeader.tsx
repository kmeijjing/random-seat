...
export function AppHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-orange-200/40 bg-orange-50/55 px-4 py-3 backdrop-blur-md dark:border-orange-800/30 dark:bg-orange-950/20 print:hidden sm:px-6 h-14">
      <Group justify="space-between" align="flex-center" gap="md" wrap="wrap">
        <Stack gap={4}>
