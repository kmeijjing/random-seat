...
export const appHeaderClass =
  `${glassPanelClass} grid grid-cols-[minmax(0,1.3fr)_minmax(360px,520px)] gap-3 items-start max-[900px]:grid-cols-1 print:hidden`
...
export const resultPanelClass =
  `${glassPanelClass} grid min-h-0 grid-rows-[auto_auto_auto_auto_1fr] gap-2.5 overflow-hidden print:block print:border-0 print:bg-white print:shadow-none`
...
export const sectionKickerClass =
  'mb-1 text-[0.68rem] font-extrabold uppercase tracking-[0.08em] text-amber-700'
export const heroTitleClass = 'm-0 text-[clamp(1.7rem,3vw,2.7rem)] leading-[0.92]'
export const panelTitleClass = 'm-0 text-[1.18rem] leading-[1.05]'
export const emptyTitleClass = 'm-0 text-2xl'
export const heroTextClass = 'mt-1.5 text-sm text-slate-600'

export const headerSummaryClass = 'grid grid-cols-2 items-stretch gap-2.5 max-[900px]:grid-cols-1'
export const headerActionsClass = 'col-span-full flex flex-wrap justify-end gap-2'
...
export const warningTextClass = 'm-0 text-[0.84rem] text-amber-700 print:hidden'
...
export const summaryCardClass =
  `${warmSurfaceClass} grid grid-cols-3 gap-2.5 p-2.5 max-[900px]:grid-cols-1`
export const actionSummaryClass =
  `${warmSurfaceClass} grid grid-cols-2 gap-2.5 p-2.5 max-[900px]:grid-cols-1`
export const subsectionClass = `${warmSurfaceClass} grid gap-2.5 p-2.5`
export const resultToolbarClass =
  `${warmSurfaceClass} flex items-end justify-between gap-2.5 p-2.5 max-[900px]:flex-col max-[900px]:items-stretch print:hidden`
export const resultMetaClass =
  `${warmSurfaceClass} flex justify-between gap-2.5 p-2.5 text-[0.82rem] text-slate-600 max-[900px]:flex-col max-[900px]:items-stretch print:hidden`
export const emptyResultClass =
  `${warmSurfaceClass} grid min-h-[320px] place-content-center gap-2 p-2.5 text-center`
export const previewMetaClass = 'text-[0.76rem] text-slate-500'
export const summaryLabelClass = 'text-[0.76rem] text-slate-500'
export const summaryValueClass = 'mt-0.5 block text-[0.96rem] font-semibold text-slate-900'
...
export const listCardClass =
  `${warmSurfaceClass} flex items-start justify-between gap-2.5 p-2.5`
export const listCardTitleClass = 'block text-[0.88rem] font-semibold text-slate-900'
export const listCardMetaClass = 'text-[0.74rem] text-slate-500'

export const searchFieldClass = 'grid min-w-[min(320px,100%)] gap-1.5 max-[900px]:min-w-full'
export const seatBoardClass = 'min-h-0 overflow-auto pr-1 print:overflow-visible print:pr-0'
